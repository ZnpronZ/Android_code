    ...
    public  void  DialogXoaLogin(String user,int id)
    {
        ...
        dialogXoa.setPositiveButton("Có", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Toast.makeText(LoginMain.this,"Đã xóa "+user,Toast.LENGTH_SHORT).show();
                GetDataLogin();
            }
        });
    ...
    public void DialogSuaLogin(String user,String pass,int id)
    {
        ...
        btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(LoginMain.this,"Đã cập nhật",Toast.LENGTH_SHORT).show();
                dialog.dismiss();
                GetDataLogin();
            }
        });
    ...
    private void DialogThem(){
        ...
        btnThem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(LoginMain.this,"Không được để trống",Toast.LENGTH_SHORT).show();
                }
                else
                {
                    database.QueryData("INSERT INTO Login VALUES(null,'" + User + "','"+ Pass +"')");
                    Toast.makeText(LoginMain.this,"Đã thêm",Toast.LENGTH_SHORT).show();
                    dialog.dismiss();
                    GetDataLogin();
