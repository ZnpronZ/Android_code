...
public class VuongToanDat_Sqlite extends SQLiteOpenHelper {
    public static final String TableName = "Contact_181201649";
...
//tao lai sql
    ...
    public  void addContact(Contact_181201649 user){
    ...
    public  void updateContact(int id,Contact_181201649 user){
    ...
    public ArrayList<Contact_181201649> getAllContact(){
        ArrayList<Contact_181201649> list = new ArrayList<>();
        ...
        if(cursor != null){
            while(cursor.moveToNext()){
                Contact_181201649 user = new Contact_181201649(cursor.getInt(0),
                        cursor.getString(1),
                        cursor.getString(2));
                list.add(user);
            }
