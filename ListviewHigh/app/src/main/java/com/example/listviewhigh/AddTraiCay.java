...
public class AddTraiCay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_traicay);
        etId = findViewById(R.id.tvTen);
        etNames = findViewById(R.id.tvMoTa);
